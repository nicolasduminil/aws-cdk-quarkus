...
public class RedisClusterProps {
  ...
  public CfnSubnetGroup getSubnetGroup() { return subnetGroup; }
  ...
  public static class Builder {
    private Vpc vpc;
    private CfnSubnetGroup subnetGroup;  // Change type
    ...
    public Builder subnetGroup(CfnSubnetGroup subnetGroup) { this.subnetGroup = subnetGroup; return this; }  // Change parameter type
